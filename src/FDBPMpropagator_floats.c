 ...
 * "mex COPTIMFLAGS='$COPTIMFLAGS -Ofast -fopenmp -std=c11 -Wall' LDOPTIMFLAGS='$LDOPTIMFLAGS -Ofast -fopenmp -std=c11 -Wall' .\src\FDBPMpropagator_floats.c ".\src\libut.lib" -R2018a"
 * ... or the Microsoft Visual C++ compiler (MSVC) with
 * "copyfile ./src/FDBPMpropagator_floats.c ./src/FDBPMpropagator_floats.cpp; mex COMPFLAGS='/Zp8 /GR /EHs /nologo /MD /openmp /W4 /WX /wd4204 /wd4100' .\src\FDBPMpropagator_floats.cpp ".\src\libut.lib" -R2018a"
 * 
 ...
 * "copyfile ./src/FDBPMpropagator_floats.c ./src/FDBPMpropagator_floats_CUDA.cu; mexcuda -llibut COMPFLAGS='-use_fast_math -res-usage $COMPFLAGS' .\src\FDBPMpropagator_floats_CUDA.cu -R2018a"
 ********************************************/
