...
P.Nx_main = 800;          % x resolution of main area
P.Ny_main = 800;          % y resolution of main area
P.padfactor = 1.5;  % How much absorbing padding to add on the sides of the main area (1 means no padding, 2 means the absorbing padding on both sides is of thickness Lx_main/2)
P.dz_target = 2e-6; % [m] z step size to aim for
...
P.Lx_main = 500e-6;        % [m] x side length of main area
P.Ly_main = 500e-6;        % [m] y side length of main area
