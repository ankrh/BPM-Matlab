...
P.xSymmetric = true; % The RIP and field distribution is invariant under mirroring in the x axis
...
P.figNum = 4;
P.xSymmetric = false; % The RIP and field distribution is invariant under mirroring in the x axis
FD_BPM(P);
