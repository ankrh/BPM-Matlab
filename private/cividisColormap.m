function cm_data = cividisColormap(m)

% cividisColormap  Perceptually uniform colormap (blue-yellow)
%
% Syntax
%   cm_data = cividisColormap();
%   cm_data = cividisColormap(m);
%
% Description
%   cm_data = cividisColormap() creates a perceptually uniform, blue-yellow
%   colormap.
% 
%   cm_data = cividisColormap(m) creates the colormap and interpolates the colours
%   across m values.
% 
